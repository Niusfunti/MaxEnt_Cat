...
df = pd.read_csv(f"../data/{esp}/oreneta_v.csv", sep=";")
...
df = df[["name_month", "x_UTM", "y_UTM", "N_indi", "month", "year", "N_obs"]]
df.to_csv(f"data/oreneta_v/oreneta_v_plot.csv", index=False)
